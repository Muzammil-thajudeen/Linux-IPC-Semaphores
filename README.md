...
## OUTPUT
$ ./sem.o 
<img width="762" height="462" alt="image" src="https://github.com/user-attachments/assets/4287d152-5158-4676-8a39-1d941ec81043" />


$ ipcs
<img width="476" height="150" alt="image" src="https://github.com/user-attachments/assets/5954ed36-ef18-4e3d-8cab-862bb767d5b3" />
...
# RESULT:
Thus the program to implement the producer/consumer system between  two processes using semaphores API  is written and verified using C programming.
